...
net{1}.layers = {} ;
net{1}.layers{end + 1} = struct('type', 'mlp', 'weights', {{f * randn(n_gates * n_hidden_nodes, n_hidden_nodes+n_input_nodes, 'single'), zeros(n_gates * n_hidden_nodes, 1, 'single')}}) ;
...
net{3}.type = 'Fit';
net{3}.layers = {};
net{3}.layers{end + 1} = struct('type', 'mlp', 'weights', {{f * randn(n_output_nodes, n_hidden_nodes, 'single'), zeros(n_output_nodes, 1, 'single')}}) ;
